export const projects = [
  {
    id: 1,
    title: "NEURO ESPACIO",
    description: "Aplicación web para gestión de citas neuropsicológicas con autenticación, sistema de roles y panel administrativo completo. (MongoDB, Express, React, Node.js). Incluye autenticación de usuarios, operaciones CRUD completas y validaciones de datos tanto en frontend como backend.",
    image: ".//images/neuroespacioimg.png",
    technologies: ["React", "Node.js", "Express", "MongoDB", "JWT"],
    github: "https://github.com/GeX90",
    demo: "https://neuro-espacio.vercel.app/",
    featured: true
  },
  {
    id: 2,
